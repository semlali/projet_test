...
<form method="get" modelAttribute="tuteur" action="saveTuteur">
    ...
    <tr>
	  ...
	  <td><input type="radio" name="sex" path="sex" required id="radio" value="femme"> <label for="radio">femme</label>
	  <td><input type="radio" name="sex" id="sex" required value="homme"> <label for="radio">homme</label>
